...
public class SavecardFragment extends android.support.v4.app.Fragment
        implements SaveCardpaymnetAdapter.OnRemoveCard, View.OnClickListener {
    ...
    private TextView tv_marchandise, tv_shippingPrice, tv_taxPrice, tv_totalPrice, tv_couponCodeName;
    private String sdiscount;
    private Intent intent;
    private Bundle bundle;
    private String cartProductArray;
    private LinearLayout ll_cardListView, ll_emptyCardView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.act_frg_savecard, container, false);
        ...
        bundle = getArguments();
        cartProductArray = bundle.getString("CartProductArray");
    ...
    private void setUpView(View v) {
        ...
        tv_couponCodeName = (TextView) v.findViewById(R.id.tv_couponCodeName);
        ...
        iv_empty_favourite = (ImageView) v.findViewById(R.id.iv_empty_favourite);
        rec_saveCardList = (RecyclerView) v.findViewById(R.id.rec_saveCardList);
        rl_btn_payNow = (RelativeLayout) v.findViewById(R.id.rl_btn_payNow);

        ll_cardListView = (LinearLayout) v.findViewById(R.id.ll_cardListView);
        ll_emptyCardView = (LinearLayout) v.findViewById(R.id.ll_emptyCardView);
        iv_emptyCard = (ImageView) v.findViewById(R.id.iv_emptyCard);
                                ...
                                if (response != null) {
                                    ...
                                    try {
                                        ...
                                        if (obj.getString(Constant.ApplyCoupon.STATUS).equals("S")) {
                                            ...
                                            String cartTotal = obj1.getString("cart_total");
                                            ...
                                            tv_discountedPrice.setText("-$" + String.format("%.2f", Double.parseDouble(discount)));
                        ...
                        if (response != null) {
                            ...
                            try {
                                ...
                                if (jsonObject.getString(Constant.RemoveCoupon.STATUS).equals("S")) {
                                    ...
                                    String cartTotal = object.getString("cart_total");
                                    tv_totalPrice.setText("$" + String.format("%.2f", Double.parseDouble(cartTotal)));
    ...
    private void fillSaveCardPaymentAdapter() {
        ...
        saveCardpaymnetAdapter = new SaveCardpaymnetAdapter(saveCardList, getActivity(), SavecardFragment.this);
 ...
 /* private void loadHeroes() {
                    ...
                    public void onResponse(String response) {
                        if (response.equals("null")) {
                            ...
                            try {
                                ...
                                edt_marchandise.setText("$" + obj2.getString("cart_total"));
                                edt_shipping.setText("$" + obj2.getString("shipping"));
                                edt_tax.setText("$" + obj2.getString("tax"));
                                tv_couponCodeName.setText("-$" + myStrValue);


                                if (obj.getString("status").equals("S")) {

                                    JSONArray jarrary = obj1.getJSONArray("saved_card_data");
                                ...
                                //Notify com.steezle.e_com.saveCardpaymnetAdapter about data changes
                                saveCardpaymnetAdapter.notifyItemChanged(i);
                            }
  ...
  /*private void onpaySuccess() {
        ...
        params11.add(new BasicNameValuePair("old_token", oldToken));
        params11.add(new BasicNameValuePair("new_token", ""));
