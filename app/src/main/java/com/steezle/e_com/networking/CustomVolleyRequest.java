...
/**
 * Created by juli on 2/10/17.
 */

public class CustomVolleyRequest {

    public static CustomVolleyRequest SIAdapter;
    ...
    public static CustomVolleyRequest getInstance(Context SynchronizedContext) {

        if (SIAdapter == null) {

            SIAdapter = new CustomVolleyRequest(SynchronizedContext);
        }
        return SIAdapter;
    }
