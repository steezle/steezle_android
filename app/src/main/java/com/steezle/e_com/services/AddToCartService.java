...
public class AddToCartService extends APIService {

    private static final String TAG = AddToCartService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.AddToCart.ADDTOCART_URL;
        ...
        try{
            ...
            StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put(Constant.AddToCart.USER_ID, user_id);
                    params.put(Constant.AddToCart.VARIATION_ID, variationId);

                    ProjectUtility.queryString("addToCart",USER_DETAIL_URL,params);
                    return params;
                }
            };
