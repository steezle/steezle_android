...
public class AddToFavouriteService extends APIService {

    private static final String TAG = AddToFavouriteService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.AddToFavourite.ADDTOFAVOURITE_URL;
    ...
    public static void addToFavourite(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.AddToFavourite.USER_ID, user_id);
                params.put(Constant.AddToFavourite.PRODUCT_ID, product_id);
                return params;
            }
        };
