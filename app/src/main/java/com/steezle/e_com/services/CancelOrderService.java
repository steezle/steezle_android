...
public class CancelOrderService extends APIService {

    private static final String TAG = CancelOrderService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.CancelOrder.CANCEL_ORDER_URL;
    ...
    public static void cancelOrder(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.CancelOrder.USER_ID, user_id);
                params.put(Constant.CancelOrder.ORDER_ID, order_id);

                ProjectUtility.queryString("cancelOrder", USER_DETAIL_URL, params);
                return params;
            }
        };
