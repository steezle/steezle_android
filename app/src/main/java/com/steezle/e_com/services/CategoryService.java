...
public class CategoryService extends APIService {
    ...
    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.Categoty.CATEGORY_URL;
    ...
    public static void getCategory(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.Categoty.USER_ID, user_id);

                ProjectUtility.queryString("getCategory==>",USER_DETAIL_URL,params);
                return params;
            }
        };
