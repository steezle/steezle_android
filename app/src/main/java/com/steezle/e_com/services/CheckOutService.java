...
public class CheckOutService extends APIService {

    private static final String TAG = CheckOutService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.CheckOut.CHECKOUT_URL;

    public static void checkOut(
            final Context context,
            final String user_id,
            final String updated_cart,
            final ProgressBar dialog,
            final Success<String> successListener) {


        //final ProgressDialog progressDialog =  ProgressDialog.show(context,null,null);//(context,R.style.customeDialog);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.CheckOut.USER_ID, user_id);
                params.put(Constant.CheckOut.UPDATED_CART, updated_cart);

                ProjectUtility.queryString("checkOut", USER_DETAIL_URL, params);
                return params;
            }
        };
