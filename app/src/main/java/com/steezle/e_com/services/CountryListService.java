...
public class CountryListService extends APIService {

    private static final String TAG = CountryListService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.CountryList.GET_COUNTRY_URL;
