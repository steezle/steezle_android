...
public class ForgotPasswordService extends APIService {

    private static final String TAG = ForgotPasswordService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.ForgotPassword.FORGOT_URL;
    ...
    public static void forgotPassword(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.ForgotPassword.EMAIL, email);

                ProjectUtility.queryString("getCountry", USER_DETAIL_URL, params);
                return params;
            }
        };
