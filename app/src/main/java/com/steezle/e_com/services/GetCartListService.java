...
public class GetCartListService extends APIService {

    private static final String TAG = GetCartListService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.GetCartList.GET_CARTLIST_URL;
    ...
    public static void getCartList(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.GetCartList.USER_ID, user_id);

                ProjectUtility.queryString("getCartList",USER_DETAIL_URL,params);
                return params;
            }
        };
