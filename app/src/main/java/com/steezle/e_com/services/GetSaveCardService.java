...
public class GetSaveCardService extends APIService {

    private static final String TAG = GetSaveCardService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.GetSaveCard.GET_SAVECARD_URL;

    public static void getSaveCard(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.GetSaveCard.USER_ID, user_id);

                ProjectUtility.queryString("getSaveCard", USER_DETAIL_URL, params);
                return params;
            }
        };
