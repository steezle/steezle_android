...
public class LogOutService extends APIService {

    private static final String TAG = LogOutService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.LogOut.LOGOUT_URL;
    ...
    public static void logout(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.LogOut.USER_ID, user_id);

                ProjectUtility.queryString("logout", USER_DETAIL_URL, params);
                return params;
            }
        };
