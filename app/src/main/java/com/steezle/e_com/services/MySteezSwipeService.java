...
public class MySteezSwipeService extends APIService {

    private static final String TAG = MySteezSwipeService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.MySteezSwipe.MYSTEEZ_SWIPE_URL;

    public static void getMySteez(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.MySteezSwipe.USER_ID, user_id);


                ProjectUtility.queryString("getMySteez", USER_DETAIL_URL, params);
                return params;
            }
        };
