...
public class OrderHistoryService extends APIService {

    private static final String TAG = OrderHistoryService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.OrderDetails.ORDER_DETAIL_URL;
    ...
    public static void getOrderHistory(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.OrderDetails.ORDER_ID, order_id);

                ProjectUtility.queryString("getOrderHistory",USER_DETAIL_URL,params);
                return params;
            }
        };
