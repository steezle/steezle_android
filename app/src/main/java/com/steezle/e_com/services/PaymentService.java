...
public class PaymentService extends APIService {
    ...
    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.MakePayment.PAYMENT_URL;
    ...
    public static void makePayment(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.MakePayment.USER_ID, user_id);
                params.put(Constant.MakePayment.NEW_TOKEN, new_token);
                params.put(Constant.MakePayment.OLD_TOKEN, old_token);
                params.put(Constant.MakePayment.SAVED, saved);

                ProjectUtility.queryString("makePayment",USER_DETAIL_URL,params);
                return params;
            }
        };
