 ...
 * Created by Hiren
 */
public class PhotoCommentDeleteService extends APIService {

    private static final String TAG = PhotoCommentDeleteService.class.getSimpleName();

    private static String USER_DETAIL_URL = APIs.Ordercancel;
