...
public class ProductDetailsService extends APIService {

    private static final String TAG = ProductDetailsService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.ProductDetail.PRODUCT_DETAIL_URL;
    ...
    public static void getProductDetails(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.ProductDetail.USER_ID, user_id);
                params.put(Constant.ProductDetail.PRODUCT_ID, product_id);


                ProjectUtility.queryString("getProductDetails", USER_DETAIL_URL, params);
                return params;
            }
        };
