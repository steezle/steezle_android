...
public class ProductFilterService extends APIService {

    private static final String TAG = ProductFilterService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.ProductFilter.PRODUCT_FILTER_URL;

    public static void getProductFilter(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.ProductFilter.USER_ID, user_id);
                params.put(Constant.ProductFilter.CATEGORY_ID, category_id);
                params.put(Constant.ProductFilter.BRAND_ID, brand_id);

                ProjectUtility.queryString("getProductFilter", USER_DETAIL_URL, params);
                return params;
            }
        };
