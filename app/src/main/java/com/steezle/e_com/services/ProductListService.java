...
public class ProductListService extends APIService {

    private static final String TAG = ProductListService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.ProductList.PRODUCTLIST_URL;
    ...
    public static void getProductList(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.ProductList.USER_ID, user_id);
                params.put(Constant.ProductList.CATEGORY_ID, category_id);
                params.put(Constant.ProductList.PAGED, paged);

                ProjectUtility.queryString("getProductList==>","<=== "+USER_DETAIL_URL,params);
                return params;
            }
        };
