...
public class RemoveCartService extends APIService {

    private static final String TAG = RemoveCartService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.RemoveCart.REMOVE_URL;
    ...
    public static void removeCart(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.RemoveCart.USER_ID, user_id);
                params.put(Constant.RemoveCart.PRODUCT_ID, product_id);
                params.put("variation_id", variation_id);

                ProjectUtility.queryString("removeCart", USER_DETAIL_URL, params);
                return params;
            }
        };
