...
public class RemoveCouponService extends APIService {

    private static final String TAG = RemoveCouponService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.RemoveCoupon.REMOVE_COUPON_URL;

    public static void removeCoupan(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.RemoveCoupon.USER_ID, user_id);

                ProjectUtility.queryString("removeCoupan",USER_DETAIL_URL,params);
                return params;
            }
        };
