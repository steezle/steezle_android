...
public class RemoveFavouriteService extends APIService {

    private static final String TAG = RemoveFavouriteService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.RemoveFavourite.REMOVE_FAVOURITE_URL;
    ...
    public static void removeFavourite(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.RemoveFavourite.USER_ID, user_id);
                params.put(Constant.RemoveFavourite.PRODUCT_ID, product_id);

                ProjectUtility.queryString("removeFavourite", USER_DETAIL_URL, params);
                return params;
            }
        };
