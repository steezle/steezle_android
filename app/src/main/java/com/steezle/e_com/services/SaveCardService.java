...
public class SaveCardService extends APIService {

    private static final String TAG = SaveCardService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.SaveCard.SAVECARD_URL;
    ...
    public static void saveCard(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.SaveCard.USER_ID, user_id);
                params.put(Constant.SaveCard.TOKEN, token);

                ProjectUtility.queryString("saveCard", USER_DETAIL_URL, params);
                return params;
            }
        };
