...
public class SearchService extends APIService {
    ...
    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.SearchList.SEARCH_URL;
    ...
    public static void getSearch(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.SearchList.USER_ID, user_id);
                params.put(Constant.SearchList.SEARCH_TEXT, searchText);

                ProjectUtility.queryString("getSearch", USER_DETAIL_URL, params);
                return params;
            }
        };
