...
public class SetAddressService extends APIService {

    private static final String TAG = SetAddressService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.SetAddress.SET_ADDRESS_URL;
    ...
    public static void setAddress(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.SetAddress.USER_ID, user_id);
                params.put(Constant.SetAddress.BILLING, billing);
                params.put(Constant.SetAddress.SHIPPING, shipping);

                ProjectUtility.queryString("setAddress", USER_DETAIL_URL, params);
                return params;
            }
        };
