...
public class SocialLoginService extends APIService {

    private static final String TAG = SocialLoginService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.SocialLogin.SOCIAL_LOGIN_URL;

    public static void getSocialLogin(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.SocialLogin.SOCIAL_DATA, socialData);
                params.put(Constant.SocialLogin.EMAIL, email);
                params.put(Constant.SocialLogin.SOCIAL_ID, socialId);
                params.put(Constant.SocialLogin.SOCIAL_TYPE, socialTypeFrom);
                return params;
            }
        };
