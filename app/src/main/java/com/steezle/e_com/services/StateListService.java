...
public class StateListService extends APIService {

    private static final String TAG = StateListService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.StateList.GET_STATE_URL;
    ...
    public static void getState(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.StateList.USER_ID, user_id);
                params.put(Constant.StateList.COUNTRY_CODE, countryCode);

                ProjectUtility.queryString("getState", USER_DETAIL_URL, params);
                return params;
            }
        };
