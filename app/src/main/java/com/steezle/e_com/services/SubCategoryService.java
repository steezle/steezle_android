...
public class SubCategoryService extends APIService {

    private static final String TAG = SubCategoryService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.SubCategories.GET_SUBCATEGORY_URL;
    ...
    public static void getSubCategory(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.SubCategories.ID, category_id);
                params.put(Constant.SubCategories.USER_ID, user_id);
                params.put(Constant.SubCategories.PAGED, page);

                ProjectUtility.queryString("getSubCategory",USER_DETAIL_URL,params);
                return params;
            }
        };
