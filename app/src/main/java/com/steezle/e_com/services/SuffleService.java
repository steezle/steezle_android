...
public class SuffleService extends APIService {

    private static final String TAG = SuffleService.class.getSimpleName();

    private static final String USER_DETAIL_URL = Constant.BASE_URL + Constant.Suffle.SUFFLE_URL;

    public static void suffleProduct(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, USER_DETAIL_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Constant.Suffle.USER_ID, user_id);
                params.put(Constant.Suffle.PAGED, paged);

                ProjectUtility.queryString("suffleProduct",USER_DETAIL_URL,params);
                return params;
            }
        };
